  ...
  static final List<Region> regions = [
    Region(
      ...
      subRegions: [
        ...
        // // 강서구
        // SubRegion(name: '화곡동', code: '6057'),
        // SubRegion(name: '마곡동', code: '6052'),
        // SubRegion(name: '염창동', code: '258'),
        // SubRegion(name: '등촌동', code: '6051'),
        // SubRegion(name: '내발산동', code: '6050'),
        // SubRegion(name: '방화동', code: '6053'),
        // SubRegion(name: '우장산동', code: '273'),
        // SubRegion(name: '가양동', code: '6047'),
        // SubRegion(name: '공항동', code: '274'),
        // SubRegion(name: '외발산동', code: '6056'),
        // SubRegion(name: '개화동', code: '6048'),
        // SubRegion(name: '오곡동', code: '6054'),
        // SubRegion(name: '과해동', code: '6049'),
        // SubRegion(name: '오쇠동', code: '6055'),
